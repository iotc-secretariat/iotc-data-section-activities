...
bl_header_no_logo = function(txt, position) {
  block_list(
    fpar(values = txt, fp_p = fp_par(text.align = position, border.bottom = fp_border()), fp_t = fp_text_lite(color = "black", bold = FALSE, font.size = 14))
  )
}
...
bl_header_with_logo = function(txt, position) {
  block_list(
    ...
    ftext = txt, 
         ...
         fp_t = fp_text_lite(color = "black", bold = FALSE, font.size = 14)))
}

sec_pr = officer::prop_section(
  header_first = bl_header_with_logo("IOTC-2024-WPDCS20-07", "right"),
  header_default = bl_header_no_logo("IOTC-2024-WPDCS20-07", "right")
)
```
